...
export class CreateContentReports1746260000000 implements MigrationInterface {
  public readonly name = 'CreateContentReports1746260000000';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`
      CREATE TABLE IF NOT EXISTS "content_reports" (
        ...
        "target_channel_id" character varying(36) NOT NULL,
        "reason" text NOT NULL,
        "evidence_timestamp_seconds" integer,
        "context_video_id" character varying(36),
        "context_video_title" character varying(200),
    ...
    await queryRunner.query(`
      ...
      WHERE "status" = 'pending'
        ...
        AND "target_video_id" IS NOT NULL
    `);
    await queryRunner.query(`
